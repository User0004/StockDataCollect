...
from fx_select_csv_and_column import selected_column
...
# Add two new columns for SMA comparison
combined_data['under_sma_100'] = combined_data['close'] < combined_data['SMA 100']
combined_data['over_sma_100'] = combined_data['close'] > combined_data['SMA 100']
